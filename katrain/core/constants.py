...
_VEIL_BLUNDER_MAX_LOSS = {
    9: [4.0, 5.0, 6.0, 8.0],
    13: [8.0, 10.0, 12.0, 15.0],  # 既定の max_loss（loose）が 6.0 なので 6.0 は外す（上限 <= max_loss は関門で止まる）
...
AI_OPTION_VALUES = {
    ...
    "parity9_max_loss_per_move": [0.5, 1.0, 1.5, 2.0, 3.0, 4.0, 5.0],
    "parity9_target_rate": [(0.2, "20%"), (0.3, "30%"), (0.4, "40%"), (0.5, "50%"), (0.6, "60%")],
    "parity9_min_winrate": [(0.5, "50%"), (0.6, "60%"), (0.7, "70%"), (0.8, "80%"), (0.9, "90%")],
    "parity9_cost_slack": [0.0, 0.3, 0.5, 1.0, 2.0],
    "parity9_yose_max_loss": [0.0, 0.05, 0.1, 0.2, 0.3, 0.5],
...
AI_OPTION_ORDER = {
    ...
    "parity9_target_rate": 0,
    "parity9_min_winrate": 1,
    "parity9_max_loss_per_move": 2,
    "parity9_cost_slack": 3,
    "parity9_endgame_move": 4,
